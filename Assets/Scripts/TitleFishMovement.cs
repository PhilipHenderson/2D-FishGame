...
public class TitleFishMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        startLocation = GameObject.FindGameObjectWithTag("startPos");
        endLocation = GameObject.FindGameObjectWithTag("endPos");
